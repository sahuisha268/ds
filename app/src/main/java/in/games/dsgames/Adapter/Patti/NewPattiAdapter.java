 ...
 */
public class NewPattiAdapter extends RecyclerView.Adapter<NewPattiAdapter.GameViewHolder> {
...
//    }
    ...
    public interface OnItemRecListener{
        void onItemTouchListener(View view, NewSelectOptionsModel item, int position,int secPosition);
        void onItemClick(View view, NewSelectOptionsModel item, int position);
    }

//    public GameAdapter.OnItemClickListener listener;
    public NewPattiAdapter.OnItemRecListener touchlistener;
...
//    }
    ...
    public NewPattiAdapter(ArrayList<NewSelectOptionsModel> gameList, Activity activity, OnItemRecListener touchlistener) {
        this.gameList = gameList;
        this.activity = activity;
...
//        }
        ...
        public void bindRec(final int pos, final NewSelectOptionsModel item, NewPattiAdapter.OnItemRecListener recListener ){
            rv_digits.addOnItemTouchListener(new RecyclerTouchListener(activity, rv_digits, new RecyclerTouchListener.OnItemClickListener() {
                ...
                public void onItemClick(View view, int position) {
                    touchlistener.onItemTouchListener(view,item,position,pos);
                }
